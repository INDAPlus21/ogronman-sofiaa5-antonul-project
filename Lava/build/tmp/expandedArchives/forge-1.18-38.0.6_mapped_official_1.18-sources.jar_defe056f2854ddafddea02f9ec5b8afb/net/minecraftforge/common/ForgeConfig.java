...
public class ForgeConfig {
    ...
    /**
     * General configuration that doesn't need to be synchronized but needs to be
     * available before server startup
     */
        ...
        Common(ForgeConfigSpec.Builder builder) {
            ...
            defaultWorldType = builder
                    .comment(
                            ...
                            "The modded world types are registry names which should include the registry namespace, such as 'lava:example_world_type'.")
    ...
    // public static boolean logCascadingWorldGeneration = true; // see
    // Chunk#logCascadingWorldGeneration()
